...
export default function Cultural() {
  return (
    <div className="main"  data-bs-spy="scroll" data-bs-target="#navContentmenu" data-bs-root-margin="0px 0px -50%" data-bs-smooth-scroll="true">
			...
			{/* <!--Banner Section ======================--> */}
			<PageBanner title="Cultural Fest" />
			{/* <!--Banner Section ======================--> */}
					...
					<div className="blog-wrapper">	
						...
						<div className="row g-4">
							...
							<div className="col-12 col-md-6 col-lg-6 col-xl-6">
                                <BlogCard image="assets/images/poster/Crime-scene-investigation.png" date="08 Dec 2024" title1="Event 1" title2="Celebrating a remarkable achievement, Harmonia Music Festival has been honored ..."/>
								
							</div>

							<div className="col-12 col-md-6 col-lg-6 col-xl-6">
                                <BlogCard image="assets/images/poster/Crime-scene-investigation.png" date="08 Dec 2024" title1="Event 2" title2="Celebrating a remarkable achievement, Harmonia Music Festival has been honored ..."/>
