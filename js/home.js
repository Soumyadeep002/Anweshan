...
// number increament animation 


const workSection = document.querySelector('.reach')
...
console.log(wh);
var element = document.querySelector("#main-logo"); //element

window.addEventListener('scroll', function(){ 
    if(scrollpos > (element.offsetTop - wh)){
        element.classList.add("main-logo");
    }
});
...
function greet() {
    tshirt.classList.remove("-translate-y-[50rem]")
}

// let closetshirt = document.getElementById('closetshirt')
document.querySelector('#closetshirt').addEventListener('click', () => {
  
    document.getElementById("tshirt").classList.add('-translate-y-[50rem]')
   
    
  })
document.querySelector('#mbutton').addEventListener('click', () => {
  
    document.getElementById("tshirt").classList.toggle('-translate-y-[50rem]')
